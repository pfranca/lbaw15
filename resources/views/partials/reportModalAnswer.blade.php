<div class="modal fade" id="reportModalAnswer" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <button id="submitReportBtnAnswer" type="button" class="buttonDown btn btn-primary btn-sm">Submit</button>
